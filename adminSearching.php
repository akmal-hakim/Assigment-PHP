...
include 'db_connect.php';
    ...
    $sql = "SELECT * FROM booking WHERE `name` LIKE '%$search%' or `email` LIKE '%$search%' or `phone` LIKE '%$search%' or `destination` LIKE '%$search%' or `package` LIKE '%$search%' or `depart` LIKE '%$search%' or `return_date` LIKE '%$search%'";
