...
<body>
		...
		<a href="adminBooking.php" class="active">Add Booking</a>
		<a href="adminView.php">View Booking</a>
	...
	<div class="contact-form">
			...
			<form name = "bookingForm" action = "adminAdd.php" method = "post">
				<div class="txtb">
				...
				<button class="btn" onClick="return confirm('Confirmation to save record?')"><b>Submit</b></a>
			</form>
	</div>
